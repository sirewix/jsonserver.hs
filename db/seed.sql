INSERT INTO users (id, name, lastname, admin, avatar, password) VALUES
    (2, 'lupa',  'Kawasaki',           false, '/author.png', '123'),
    (3, 'pupa',  'Erricson',           false, '/user.png',   '123');
...
INSERT INTO posts (title, author, category, content, main_image, images, published) VALUES
    ('title0', 1, 4, 'asdfe',    'img.png', array['hi', 'by'], true),
    ('title1', 1, 2, 'nubvryu',  'img.png', array['hi'],       true),
    ('title2', 2, 4, 'ovnet',    'img.png', array[]::text[],   true),
    ('title3', 2, 2, 'weroihzb', 'img.png', array[]::text[],   true),
    ('title4', 2, 2, 'lkmug',    'img.png', array[]::text[],   true);
